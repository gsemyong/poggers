import type {
  ...
  ComponentParameters,
  ComponentPartName,
  ComponentWritableValues,
  ComponentValues,
  ComponentValueKinds,
} from "./app";
import type { DragRelease } from "./web";
...
type TokenRefOfGroup<Tokens, Group extends VisualTokenGroup> = Tokens extends unknown
...
type ComponentScopeValues<Spec extends AppSpec, Component extends ComponentName<Spec>> = {
  readonly [Name in keyof ComponentValues<Spec, Component>]: Name extends keyof ComponentValueKinds<
    Spec,
    Component
  >
    ? VisualNumberExpression<ComponentValueKinds<Spec, Component>[Name] & VisualValueKind>
    : ReactiveValue<ComponentValues<Spec, Component>[Name]>;
};

declare const visualEventReference: unique symbol;
declare const visualPartReference: unique symbol;

export type VisualEventReference<Event> = {
  readonly [visualEventReference]: Event;
};
...
type ComponentEventReferenceForArgs<
  Spec extends AppSpec,
  Component extends ComponentName<Spec>,
  Args extends readonly unknown[],
> = {
  [Event in keyof ComponentEvents<Spec, Component>]: ComponentEventArgs<
    ComponentEvents<Spec, Component>[Event]
  > extends Args
    ? VisualEventReference<ComponentEvents<Spec, Component>[Event]>
    : never;
}[keyof ComponentEvents<Spec, Component>];

type ComponentWritableValueReferences<
  Spec extends AppSpec,
  Component extends ComponentName<Spec>,
> = {
  readonly [Name in keyof ComponentWritableValues<
    Spec,
    Component
  >]: Name extends keyof ComponentValueKinds<Spec, Component>
    ? VisualNumberExpression<ComponentValueKinds<Spec, Component>[Name] & VisualValueKind>
    : ReactiveValue<ComponentWritableValues<Spec, Component>[Name]>;
};
...
type PresetDragInteraction<Spec extends AppSpec, Component extends ComponentName<Spec>> = {
  ...
  readonly output: {
    readonly inline?: ComponentWritableValueReferences<
      Spec,
      Component
    >[keyof ComponentWritableValueReferences<Spec, Component>];
    readonly block?: ComponentWritableValueReferences<
      Spec,
      Component
    >[keyof ComponentWritableValueReferences<Spec, Component>];
    readonly velocityInline?: ComponentWritableValueReferences<
      Spec,
      Component
    >[keyof ComponentWritableValueReferences<Spec, Component>];
    readonly velocityBlock?: ComponentWritableValueReferences<
      Spec,
      Component
    >[keyof ComponentWritableValueReferences<Spec, Component>];
    readonly progressInline?: ComponentWritableValueReferences<
      Spec,
      Component
    >[keyof ComponentWritableValueReferences<Spec, Component>];
    readonly progressBlock?: ComponentWritableValueReferences<
      Spec,
      Component
    >[keyof ComponentWritableValueReferences<Spec, Component>];
  };
  readonly start?: ComponentEventReferenceForArgs<Spec, Component, readonly []>;
  readonly release: ComponentEventReferenceForArgs<Spec, Component, readonly [DragRelease]>;
  readonly cancel?: ComponentEventReferenceForArgs<Spec, Component, readonly []>;
};
...
export type PresetComponentScope<Spec extends AppSpec, Component extends ComponentName<Spec>> = {
  readonly values: ComponentScopeValues<Spec, Component>;
  readonly writableValues: ComponentWritableValueReferences<Spec, Component>;
  readonly events: {
    readonly [Event in keyof ComponentEvents<Spec, Component>]: VisualEventReference<
      ComponentEvents<Spec, Component>[Event]
    >;
  };
  readonly parts: {
