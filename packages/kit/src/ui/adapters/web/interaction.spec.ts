...
import {
  ...
  type DragOptions,
  type DragSample,
} from "#ui/adapters/web/drag";
import { createAnimeDragDriver, type AnimeDragFactory } from "#ui/adapters/web/drag.anime";
import { createPress, createShortcut } from "#ui/adapters/web/interaction";
