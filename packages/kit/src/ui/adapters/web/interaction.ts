import { mountAnimeDrag } from "#ui/adapters/web/drag.anime";
import { mountDialog as mountRetainedDialog } from "#ui/adapters/web/runtime";

export type { DragOptions, DragRelease, DragSample } from "#ui/adapters/web/drag";
import type { DragOptions } from "#ui/adapters/web/drag";
