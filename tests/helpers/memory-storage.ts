import type { ClientStore } from "infra/store/types";
import type { Store } from "infra/store/types";

import type { ServerAdapter } from "infra/store/adapter-types";
...
export function createMemoryServerAdapter(): ServerAdapter {
  return createSingleNodeAdapter(createMemoryStore());
}
