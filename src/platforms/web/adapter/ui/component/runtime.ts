...
import type { WebDeferredDataIR } from "@/platforms/web/adapter/document";
import {
  adoptSceneChildren,
...
import { observeWebDeferredState, type WebDeferredState } from "@/platforms/web/adapter/ui/stream";
