...
} from "@/platforms/web/adapter/presentation/runtime/execution";
import {
  createWebLayoutHost,
  type WebLayoutHost,
} from "@/platforms/web/adapter/presentation/runtime/layout";
import {
  createWebElementObservationHost,
  createWebEnvironmentHost,
  type WebElementSnapshot,
} from "@/platforms/web/adapter/presentation/runtime/observations";
import {
  readPresentationPresence,
  setPresentationPresence,
} from "@/platforms/web/adapter/ui/presence";
import type {
  WebAudioAsset,
