...
type Ref<T extends Element> = (element: T) => void | (() => void);
...
type AriaAttributes = {
  ...
  "aria-atomic"?: AttributeValue<Booleanish>;
  "aria-autocomplete"?: AttributeValue<"none" | "inline" | "list" | "both">;
  "aria-braillelabel"?: AttributeValue<string>;
  "aria-brailleroledescription"?: AttributeValue<string>;
  "aria-busy"?: AttributeValue<Booleanish>;
  "aria-checked"?: AttributeValue<Booleanish | "mixed">;
  "aria-colcount"?: AttributeValue<number>;
  "aria-colindex"?: AttributeValue<number>;
  "aria-colindextext"?: AttributeValue<string>;
  "aria-colspan"?: AttributeValue<number>;
  "aria-controls"?: AttributeValue<string>;
  "aria-current"?: AttributeValue<Booleanish | "page" | "step" | "location" | "date" | "time">;
  "aria-describedby"?: AttributeValue<string>;
  "aria-description"?: AttributeValue<string>;
  "aria-details"?: AttributeValue<string>;
  "aria-disabled"?: AttributeValue<Booleanish>;
  "aria-errormessage"?: AttributeValue<string>;
  "aria-expanded"?: AttributeValue<Booleanish>;
  "aria-flowto"?: AttributeValue<string>;
  "aria-haspopup"?: AttributeValue<Booleanish | "menu" | "listbox" | "tree" | "grid" | "dialog">;
  "aria-hidden"?: AttributeValue<Booleanish>;
  "aria-invalid"?: AttributeValue<Booleanish | "grammar" | "spelling">;
  ...
  "aria-modal"?: AttributeValue<Booleanish>;
  "aria-multiline"?: AttributeValue<Booleanish>;
  "aria-multiselectable"?: AttributeValue<Booleanish>;
  ...
  "aria-pressed"?: AttributeValue<Booleanish | "mixed">;
  "aria-readonly"?: AttributeValue<Booleanish>;
  "aria-relevant"?: AttributeValue<string>;
  "aria-required"?: AttributeValue<Booleanish>;
  "aria-roledescription"?: AttributeValue<string>;
  "aria-rowcount"?: AttributeValue<number>;
  "aria-rowindex"?: AttributeValue<number>;
  "aria-rowindextext"?: AttributeValue<string>;
  "aria-rowspan"?: AttributeValue<number>;
  "aria-selected"?: AttributeValue<Booleanish>;
...
export type WebForKey = string | number;
...
export type WebForBaseProps<Items extends readonly unknown[]> = {
  each: Items | (() => Items);
  by?: Extract<keyof Items[number], string> | ((item: Items[number], index: number) => WebForKey);
  children: (item: Items[number], index: number) => Child;
  fallback?: Child;
  virtual?: false;
};

export type WebVirtualActive<Key extends WebForKey> = Key | (() => Key | undefined);

export type WebVirtualPropertyKey<Items extends readonly unknown[]> = {
  [Key in Extract<keyof Items[number], string>]: Extract<
    Items[number][Key],
    WebForKey
  > extends never
    ? never
...
export type WebVirtualForByProperty<
  Items extends readonly unknown[],
  Key extends WebVirtualPropertyKey<Items> = WebVirtualPropertyKey<Items>,
> = Omit<WebForBaseProps<Items>, "by" | "virtual"> & {
  by: Key;
  virtual: true | VirtualForOptions;
  active?: WebVirtualActive<NoInfer<Extract<Items[number][Key], WebForKey>>>;
};

export type WebVirtualForByFunction<Items extends readonly unknown[]> = Omit<
  WebForBaseProps<Items>,
  "by" | "virtual"
> & {
  by: (item: Items[number], index: number) => WebForKey;
  virtual: true | VirtualForOptions;
  active?: WebVirtualActive<WebForKey>;
};

export type WebVirtualForProps<
  Items extends readonly unknown[],
  Key extends WebVirtualPropertyKey<Items> = WebVirtualPropertyKey<Items>,
> = WebVirtualForByProperty<Items, Key> | WebVirtualForByFunction<Items>;

export type WebForProps<
  Items extends readonly unknown[],
  Key extends WebVirtualPropertyKey<Items> = WebVirtualPropertyKey<Items>,
> = WebForBaseProps<Items> | WebVirtualForProps<Items, Key>;
...
type WebFor = {
  <
    ...
    Key extends WebVirtualPropertyKey<Items> = WebVirtualPropertyKey<Items>,
  >(
    props: WebForProps<Items, Key>,
  ): JSXElement;
};

/** Runtime operations supplied by the mounted web adapter to its public authoring language. */
export type WebUIRuntime = Readonly<{
  Await<Value>(props: {
  ...
  For: WebFor;
  Show(props: { when: unknown; children: Child; fallback?: Child }): JSXElement;
  createPress(activate: () => void): PressBindings;
  createShortcut(shortcut: Shortcut, activate: () => void): ShortcutBinding;
  mountDialog(element: HTMLDialogElement, readMode: () => DialogMode): void;
