...
import { buildRustProgram, createRustProgramSession } from "@/core/compiler/rust";
import { compileApplication } from "@/core/compiler/source";
import { executeProgramFixtureIR } from "@/core/development";
  ...
  programs: {
    worker: {
      async start({ capabilities }: {
        ...
        const value = await capabilities.input.read({});
        ...
        await capabilities.output.write(result);
      },
    },
  },
