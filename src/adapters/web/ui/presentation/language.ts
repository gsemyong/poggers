import type { IntrinsicElements } from "@/adapters/web/ui/component/language";
import type { WebSpring, WebTrack, WebTween } from "@/adapters/web/ui/presentation/dynamics";
